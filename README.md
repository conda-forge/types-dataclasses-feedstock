...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-dataclasses-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13148&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-dataclasses-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-dataclasses` can be installed with:

```
conda install types-dataclasses
```

It is possible to list all of the versions of `types-dataclasses` available on your platform with:
